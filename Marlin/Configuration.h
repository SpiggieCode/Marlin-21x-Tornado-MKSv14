...
#define STRING_CONFIG_H_AUTHOR "(Earth Federation, Side 7)" // Who made the changes.
...
//#define CUSTOM_MACHINE_NAME "Gundam Maker"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 10.2
  #define DEFAULT_bedKi 0.64
  #define DEFAULT_bedKd 109.70
